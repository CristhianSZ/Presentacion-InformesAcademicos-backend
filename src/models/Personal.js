...
const PersonalModel = db.define('personal', {
  id_personal: {
  ...
  id_cargo: {
    ...
    allowNull: true,
    references: {
      model: 'tipo_cargo', // Debe coincidir con el nombre de la tabla cursos
      key: 'id_cargo',
    }
  }
}, {
  timestamps: false,
  tableName: 'personal', // Asegura que coincida con el nombre de la tabla
});
